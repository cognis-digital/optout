#!/usr/bin/env sh
# Universal installer for optout. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/optout.git"
echo "Installing optout ..."
