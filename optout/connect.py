"""Native cognis-connect emit for optout — forward findings to any platform.

Maps optout's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    optout ... --format json | optout-emit --to stix
    optout-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
